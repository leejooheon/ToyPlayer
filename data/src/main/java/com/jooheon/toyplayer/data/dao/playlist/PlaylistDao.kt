package com.jooheon.toyplayer.data.dao.playlist
...
//    @Query("UPDATE playlist_table SET name= :mName, thumbnail= :mThumbnail WHERE id LIKE :mID")
//    suspend fun update(mID: Int, mName: String, mThumbnail: String)
}