...
class CustomColors(
    ...
    var material3Colors by mutableStateOf(material3Colors)
        private set
    ...
    fun update(other: CustomColors) {
        material3Colors = other.material3Colors
    ...
    fun copy(): CustomColors = CustomColors(
        material3Colors = material3Colors,
    ...
    fun update(colorScheme: ColorScheme): CustomColors {
        material3Colors = colorScheme
        return this
    }
}