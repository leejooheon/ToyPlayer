...
inline var MediaMetadataCompat.Builder.data: String
    @Deprecated(NO_GET, level = DeprecationLevel.ERROR)
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
        putString(METADATA_KEY_DATA, value)
    }
inline val MediaMetadataCompat.data
    get() = this.getString(METADATA_KEY_DATA)

const val METADATA_KEY_FLAGS = "com.jooheon.clean_architecture.presentation.media.METADATA_KEY_FLAGS"
const val METADATA_KEY_DATA  = "com.jooheon.clean_architecture.presentation.media.METADATA_KEY_DATA"
